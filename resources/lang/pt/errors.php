...
return array (
  ...
  array (
    ...
    'description' =>
        array (
            'fieldName' => 'Descrição',
            'min' => 'A sua descrição deve ter no minimo 150 caracteres',
            'max' => 'A sua descrição deve ter no máximo 200 caracteres',
        ),
  ...
  'invalidLink' => 'O Link não é uma URL válida',
  'adsAtLeast3Days' => 'A sua publicidade deve ter pelo menos 3 dias de duração.',
