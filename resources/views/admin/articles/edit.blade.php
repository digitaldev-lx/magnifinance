                        ...
                        <div class="row">
                            <div class="col-md">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" id="title" class="form-control form-control-lg" @if (!empty($article)) value="{{ $article->title }}" @endif autocomplete="off">
                                </div>
                            </div>
                            <div class="col-md">
                                <div class="form-group">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <button type="button" id="submit-approval-form" class="btn btn-primary btn-light-round"><i
                                            class="fa fa-check"></i> {{__('app.submitApproval')}}</button>
                                </div>
    ...
    <script>
        ...
        function submitForm(status){
            $.easyAjax({
                ...
                file:true,
                formReset:false,
                data: {data: $('#createForm').serialize(), status: status},
        ...
        $('body').on('click', '#submit-approval-form', function() {
            submitForm('pending')
        });
