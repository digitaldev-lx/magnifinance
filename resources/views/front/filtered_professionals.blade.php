<div class="mt-4 d-flex flex-wrap">
    @foreach ($professionals as $service)
            ...
            <div class="card single_deal_box border-0">
                <div class="card-image position-relative">
                    ...
                    @if ($service->ratings->count() > 0 && $settings->rating_status == 'active')
                        <span class="badge badge-danger rating" id="badge-ribbon">{{round($service->average_rating, 1)}}</span>
...
<div class="deals_pagination mt-4 d-flex justify-content-center" id="pagination" style="margin-bottom: 50px">
    <a
        href="/{{isset($article) ? $article->category->slug : 'all'}}/services"
        class="btn btn-dark">
        {{ __('app.viewAll') }} {{ __('menu.professionals') }}
    </a>
</div>
